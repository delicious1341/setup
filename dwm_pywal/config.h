...
#include "/home/abhay/.cache/wal/colors-wal-dwm.h"
...
static const Rule rules[] = {
	...
	RULE(.wintype = WTYPE "UTILITY", .isfloating = 0) // for firefox picture in picture window
...
static const BarRule barrules[] = {
	...
	{ -1,	     0,     BAR_ALIGN_CENTER, width_status,             draw_status,            click_status,            NULL,                    "status" },
	...
	#elif BAR_STATUS_PATCH
	{ -1,	     0,     BAR_ALIGN_RIGHT_RIGHT, width_status_es,     draw_status_es,         click_status,            NULL,                    "status_es" },
	#endif // BAR_STATUS2D_PATCH | BAR_STATUSCMD_PATCH
	#endif // BAR_EXTRASTATUS_PATCH
	#if BAR_FLEXWINTITLE_PATCH
...
/* Custom functions for key binds */
#include <X11/XF86keysym.h>
static const char *upvol[]  = { "sh", "-c", "pamixer -u -i 1 && kill -39 $(pidof dwmblocks)", NULL };
static const char *downvol[]  = { "sh", "-c", "pamixer -d 1 && kill -39 $(pidof dwmblocks)", NULL };
static const char *mutevol[]  = { "sh", "-c", "pamixer -t && kill -39 $(pidof dwmblocks)", NULL };
...
static const Key keys[] = {
	...
	#endif // XRDB_PATCH
//	{ MODKEY,                       XK_t,          setlayout,              {.v = &layouts[0]} }, // tile layout removed
//	{ MODKEY,                       XK_f,          setlayout,              {.v = &layouts[1]} }, // floating layout never to be selected
//	{ MODKEY,                       XK_m,          setlayout,              {.v = &layouts[2]} }, // monocle layout removed
	#if COLUMNS_LAYOUT
